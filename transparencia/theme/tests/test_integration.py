...
class BasicTest(unittest.TestCase):
    ...
    def test_TransparenciaTheme_layers_available(self):
        self.failUnless('TransparenciaTheme_custom' in self.portal.portal_skins)

    def test_TransparenciaTheme_skin_installed(self):
        self.skins = self.portal.portal_skins
        theme = self.skins.getDefaultSkin()
        self.failUnless(theme == 'TransparenciaTheme', 'Default theme is %s' % theme)
...
class BootstrapTraversalTest(unittest.TestCase):
    ...
    def testGWResourceTraversal(self):
        ...
        self.browser.open('%s/++transparencia++stylesheets/TransparenciaTheme.css' % portalURL)
